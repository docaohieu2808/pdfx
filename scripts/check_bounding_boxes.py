...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Check fields.json for overlapping bounding boxes.")
    parser.add_argument("fields_json", help="Input fields.json file (see forms.md)")
