...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Fill fillable PDF form fields from a JSON values file.")
    parser.add_argument("input_pdf", help="Input PDF file")
    parser.add_argument("field_values_json", help="JSON file with field values")
